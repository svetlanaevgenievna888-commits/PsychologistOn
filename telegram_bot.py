...
# Тестовый режим:
#   Пароль #1: wZnR7e1cbF7OLzdJfJ98
#   Пароль #2: UcVg91kjMuAD6UnU5Er9
#
# Переключение режима:
#   ROBOKASSA_TEST_MODE = "0"  -> боевой режим (IsTest не передаётся)
#   ROBOKASSA_TEST_MODE = "1"  -> тестовый режим (IsTest=1)
ROBOKASSA_TEST_MODE = os.getenv("ROBOKASSA_TEST_MODE", "0")  # по умолчанию боевой режим

if ROBOKASSA_TEST_MODE == "1":
    # Тестовые пароли
    ROBOKASSA_PASSWORD_1 = os.getenv("ROBOKASSA_PASSWORD_1", "wZnR7e1cbF7OLzdJfJ98")
    ROBOKASSA_PASSWORD_2 = os.getenv("ROBOKASSA_PASSWORD_2", "UcVg91kjMuAD6UnU5Er9")
else:
    # Боевые пароли
    ROBOKASSA_PASSWORD_1 = os.getenv("ROBOKASSA_PASSWORD_1", "d96w1OM0WCXrh6jmOWHw")
    ROBOKASSA_PASSWORD_2 = os.getenv("ROBOKASSA_PASSWORD_2", "ZzDu3Qe2RFAI5CrSw12X")
