...
# Параметры проведения ТЕСТОВЫХ платежей (из технических настроек Robokassa)
# Алгоритм расчета хеша: MD5
# Пароль #1: d96w1OM0WCXrh6jmOWHw
# Пароль #2: ZzDu3Qe2RFAI5CrSw12X
# При переходе в боевой режим замените эти значения в переменных окружения.
ROBOKASSA_PASSWORD_1 = os.getenv("ROBOKASSA_PASSWORD_1", "d96w1OM0WCXrh6jmOWHw")  # Пароль #1 для генерации подписи
ROBOKASSA_PASSWORD_2 = os.getenv("ROBOKASSA_PASSWORD_2", "ZzDu3Qe2RFAI5CrSw12X")  # Пароль #2 для проверки уведомлений
